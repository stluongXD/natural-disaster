...
#criminologists and other experts on various aspects of homicide who work for the organization. <p>

#<div> 
 
#<p> Through the charts, you would be able to answer the following questions.<p> 
...
#<p> Do people with specific race tend to share a similar incident? For example, do white people experience death because of a love triangle? <p>

#<li>Is gender connected to type of murder committed? <li> 

#<p> Does one gender experience a specific type of death? For example, do women experience deaths related to robbery often? <p>
